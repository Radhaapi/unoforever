...
def help_handler(update: Update, context: CallbackContext):
    ...
    help_text = _("Follow these steps:\n\n"
      ...
      "<a href=\"https://telegram.me/storebot?start=Uno_ForeverBot\">"
      "rate me</a>, join the "
      "<a href=\"https://telegram.me/Crush_Forever\">update channel</a>"
...
def source(update: Update, context: CallbackContext):
    ...
    source_text = _("This bot is Free Software and licensed under the AGPL. "
      ...
      "https://github.com/jh0ker/Uno_ForeverBot")
...
def news(update: Update, context: CallbackContext):
    ...
    send_async(context.bot, update.message.chat_id,
               text=_("All news here: https://telegram.me/Crush_Forever"),
               disable_web_page_preview=True)
